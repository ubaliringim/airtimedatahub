...
const NetworkSelector: React.FC<NetworkSelectorProps> = ({ selectedNetwork, onSelectNetwork }) => {
  return (
    <div >
      <h3 className="text-lg font-semibold mb-2 text-[#060606] text-center">Select Network</h3>
        ...
        {networks.map((network) => (
          <button
            ...
            className={`flex flex-col items-center justify-center p-6 rounded-2xl border transition-all duration-150 bg-white hover:scale-105 focus:outline-none
              ${selectedNetwork === network.name ? 'border-2 border-[#229ED9] text-[#229ED9] font-bold' : 'border-gray-200 text-gray-700'}`}
